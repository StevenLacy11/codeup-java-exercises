...
//		}
		...
		Candy funsizeSnickers = new Candy("Snickers", "fun-size", new String[]{"treenut alergy", "classic"});
		Candy fullsizeKitKat = new Candy("Kit-Kat", "full-size", new String[]{"waffer", "chocolate-covering", "classic"});
